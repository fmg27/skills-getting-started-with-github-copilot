...
activities = {
    ...
    "Music Ensemble": {
        "description": "Join our instrumental and vocal music groups",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["david@mergington.edu", "mia@mergington.edu", "lucas@mergington.edu"]
    },
    "Science Club": {
...
# Permite ejecutar el servidor con: python app.py
